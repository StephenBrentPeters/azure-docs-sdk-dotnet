...
ms.service: eventhub
---
# Azure Event Hubs Event Processor client library for .NET - Version 5.7.0-alpha.20220429.1 
...
For detailed information about exceptions that may occur, please refer to the Event Hubs client library [README]( https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/eventhub/Azure.Messaging.EventHubs/README.md#event-hubs-exception) and the service documentation for [Event Hubs messaging exceptions](/azure/event-hubs/event-hubs-messaging-exceptions). 
