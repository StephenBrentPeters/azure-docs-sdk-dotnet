...
---
# Azure ExtendedLocation Management client library for .NET - Version 1.0.0-alpha.20220503.1 
...
```dotnetcli
dotnet add package Azure.ResourceManager.ExtendedLocation --prerelease
```
